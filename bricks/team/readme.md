# Team Brick Component

Team member cards with image, name, role, and hover social links.
...
```njk
{% from "bricks/team/molecules.njk" import renderTeam %}
{{ renderTeam({ items: teamMembers }) }}
```
