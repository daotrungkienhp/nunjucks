...
Call-to-action banner with gradient backgrounds, title, subtitle, and action buttons. Three variants: primary (gold/blue gradient), secondary, muted.

## Markdown Usage

:::Cta
variant: "primary"
title: "Bạn cần tìm dự án phù hợp với dòng tiền?"
subtitle: "Kiến An Cư hỗ trợ tư vấn quy hoạch Hà Đông miễn phí"
label: "Tư vấn miễn phí"
buttons:
  - label: "Gọi ngay: 0328.69.62.61"
    url: "tel:0328696261"
    variant: "primary"
...
```njk
{% from "bricks/cta/molecules.njk" import renderCta %}
{{ renderCta({ title: "Tiêu đề", variant: "primary", buttons: [...] }) }}
```
