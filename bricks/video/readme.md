# Video Brick Component

Video embed with YouTube, Vimeo, or direct MP4 support. Includes thumbnail overlay with play button.
...
```njk
{% from "bricks/video/molecules.njk" import renderVideo %}
{{ renderVideo({ video: { type: "youtube", url: "..." } }) }}
```
