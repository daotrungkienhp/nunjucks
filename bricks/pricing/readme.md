# Pricing Brick Component

Pricing table/plan cards with features list, price display, badge, and CTA button. Supports featured/variant styling.
...
plans:
  - name: "Gói Cơ bản"
    ...
    currency: "tỷ"
    period: ""
    description: "Dành cho căn hộ chung cư"
    features:
      - text: "Tư vấn pháp lý cơ bản"
      - text: "Hỗ trợ thủ tục vay"
      - text: "Hỗ trợ 24/7"
        included: false
    button:
      label: "Đăng ký ngay"
...
```njk
{% from "bricks/pricing/molecules.njk" import renderPricing %}
{{ renderPricing({ plans: pricingData }) }}
```
