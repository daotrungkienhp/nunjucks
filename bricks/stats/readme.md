# Stats Brick Component

Animated statistics/counter display with Alpine.js scroll-triggered count-up animation.
...
```njk
{% from "bricks/stats/molecules.njk" import renderStats %}
